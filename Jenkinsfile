pipeline {
    ...
    stages {
      ...
      steps{   
       ...
       stage('Deploy'){ 
         steps{
            ansiblePlaybook credentialsId:'ansiblessh', disableHostKeyChecking:true, installation:'ansible', inventory:'root@172.31.6.48:/etc/ansible/hosts', playbook:'root@172.31.6.48:/etc/ansible/playbook.yaml  ', vaultTmpPath: ''
               }
           }
